(() => {
    ...
    function initSliders() {
        if (document.querySelector(".swiper")) {
            ...
            const productTbumbs = new core(".thumbs-images__slider ", {
            ...
            new core(".thumbs-videos__slider ", {
                modules: [ Navigation, Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: 2,
    ...
    if (catalogOpenButton && catalogOpen) catalogOpenButton.addEventListener("click", (e => {
